...
{
    /// <inheritdoc />
    public partial class StarProject : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MentorProfile_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentProfile_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyWorkIn", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyWorkIn_MentorProfile_MentorProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyWorkIn_MentorProfileId",
                table: "CompanyWorkIn",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MentorProfile_ApplicationUserId",
                table: "MentorProfile",
                column: "ApplicationUserId",
                unique: true);
